...
<head>
	...
	<!-- Web Font -->
	<link href="https://fonts.googleapis.com?family=Poppins:200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&display=swap" rel="stylesheet">
                        ...
                        <div class="tab-pane fade show active" id="man" role="tabpanel">
                            <div class="tab-single">
                                <div class="row">
                                    <?php
                                        $db =new dbconnect();
                                        $result = $db->getData("SELECT * FROM `san_pham` where id_loai_sp= 3");

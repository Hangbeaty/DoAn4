						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" href="http://127.0.0.1:8000/user/sachgiaoduc" role="tab">Sách giáo dục</a></li>
									<li class="nav-item"><a class="nav-link" href="http://127.0.0.1:8000/user/sachkhac" role="tab">Sách khác</a></li>
									<li class="nav-item"><a class="nav-link" href="http://127.0.0.1:8000/user/truyenma" role="tab">Truyện ma</a></li>

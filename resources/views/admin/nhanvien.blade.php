            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" id="tennv" ng-model="nhanvien.ten_nhanvien">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                          class="form-control" id="ngaysinh" ng-model="nhanvien.ngaysinh">
                    </div>
                    <div class="form-group">
                        <label for="qq">Que Quan</label>
                        <input type="text"
                          class="form-control" id="qq" ng-model="nhanvien.quequan">
                    </div>
                    <div class="form-group">
                        <label for="sdt">So Dien Thoai</label>
                        <input type="text"
                          class="form-control" id="sdt" ng-model="nhanvien.sdt">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="text"
                          class="form-control" id="email" ng-model="nhanvien.email">
                    </div>
                    <div class="form-group">
                        <label for="capbac">Cấp Bậc</label>
                        <input type="text"
                          class="form-control" id="capbac" ng-model="nhanvien.capbac">
                    </div>
                </div>
